...
<title>Transportation | Makkah</title>
...
#firstPanel {
	...
	background-image: url("/Makkah/files/transport.jpg");
	...
	<div id="generalPanel" class="cl-12 cl-t-12 cl-m general_panel">
		...
		<div id="firstPanel" class="panel main_panel">
			...
			<div id="secondPanel" class="panel main_panel">
				<h1 class="welcome_msg">Transportations in Makkah</h1>
				<div id="infoSlides">
				@foreach($transportations as $trans)
				<div class="info_slide">
					<div class="info_img cl-2 cl-t-2">
						<img src="/Makkah/files/taxis_2.png" alt="Picture">
					</div>
					<div class="info_cont cl-10 cl-t-10">
						Rate: 
							<?php if(isset($trans['rating'])){
							 for($i=0;$i<(int)$trans['rating'];$i++){?>
							
							<i class="fa fa-star"></i>
							<?php }?>	
							<?php for($j=0;$j<(5)-(int)$trans['rating'];$j++){?>
						...
						Name: {{$trans['name']}}
						<br>
						City: {{$trans['formatted_address']}}
						<br>
						Phone:{{isset($trans['international_phone_number']) ?$trans['international_phone_number']  : "No NN"}}, {{isset($transportation['formatted_phone_number']) ?$transportation['formatted_phone_number']  : ""}}
